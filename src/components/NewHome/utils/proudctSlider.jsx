...
//     console.log("qunatity------------" ,quantity,"availableQuantity------------" ,availableQuantity)
                            ...
                            {isInCart(product._id) ? (
                                ...
                                {addToCartLoader[product._id] ? (
                                  ...
                                  <div className="cart-quantity d-flex gap-2 align-items-center">
                                    ...
                                    <LazyLoadImage effect="blur"
                                      ...
                                      alt="AddIcon"
                                      className='Icon_add_to_cart'
                                      onClick={() => handleAddToCart(product._id, quantities[product._id] || 0, product?.quantity)}
                                      style={{ cursor: "pointer" }}
                                    />
                                  </div>
                                )}
                              ...
                              <div>
                                {addToCartLoader[product._id] ? (
                                  ...
                                  <div className="ADD_button_new_home_page text-black" onClick={() => handleAddToCart(product._id, quantities[product._id] || 0, product?.quantity)} style={{ cursor: "pointer" }}>ADD</div>
                                )}
                              </div>
                            )}
                          </div>
