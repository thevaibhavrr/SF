                ...
                <div className='ecom_bar_main_div' >
                    <div className='ecom_bar_items_div' >
                        <Link to={"/product/all-products"} className='css-for-link-tag-color'  >
                            <div><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-house" viewBox="0 0 16 16">
                    ...
                    <div className='ecom_bar_items_div'  onClick={() => handelclick("Cart")} >
                        ...
                        <div >
                            <div style={{position:"relative"}}>
                                ...
                                {
                                    cartCount > 0 &&
                                    <span className='cart-count-for-e-com-bar' >{cartCount}</span>
                                }
                            </div>
                        </div>
                        <div>
                    ...
                    <div className='ecom_bar_items_div' onClick={() => handelclick("Profile")} >
                        ...
                        {IsLogin ? <div>Profile</div> : <div onClick={() => setShowPopup(true)} >Login</div>}
