    ...
    return (
        <div className='main_contact_journey' >
            ...
            <div className='contact_journey_divs journy_left'>
                ...
                <div>
                    <img loading="lazy" src={product_image} alt="product_image" className='jounry_images jounry_images_first'/>
                </div>
            </div>
            {/* center */}
            <div className='contact_journey_divs journy_center'>
                <div className='journy_center_imaage_div' >
                    <img loading="lazy" src={masala_image} alt="masala_image" className='jounry_images  ' />
                </div>
            </div>
            {/* right */}
