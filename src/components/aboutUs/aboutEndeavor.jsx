        ...
        <>
            <div className='endeavor_main_div' >
                ...
                <div className='endeavor_images_div' >
                    <div><img loading="lazy" src={Quality} alt="Quality" className='endeavor_images' /></div>
                    <div><img loading="lazy" src={Authenticity} alt="Authenticity" className='endeavor_images' /></div>
                    <div><img loading="lazy" src={Flavor} alt="Flavor" className='endeavor_images' /></div>
                    <div><img loading="lazy" src={Excellence} alt="Excellence" className='endeavor_images' /></div>
                </div>
